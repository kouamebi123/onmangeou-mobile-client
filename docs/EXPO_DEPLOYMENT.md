...
Projet : https://expo.dev/accounts/manu99/projects/onmangeou
Identifiant : `b99b0cce-bdc3-4628-9513-2f4cb79fd65e`.
...
Pour Android, définir GOOGLE_MAPS_ANDROID_API_KEY dans chacun de ces environnements Expo avec une visibilité permettant la résolution de app.config.ts par EAS CLI (plain text ou sensitive). Restreindre cette clé à ci.onmangeou.client et à l'empreinte du certificat Android utilisé. La clé finit dans le binaire : ce n'est pas un secret serveur. Sans cette configuration la carte Android n'est pas validée.
